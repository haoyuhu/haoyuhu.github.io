Code used to be the expensive part. You could have the right idea, the right system boundary, even the right product instinct—and still get buried by implementation cost. That is less true now. As code generation improves, the center of gravity in software engineering is being pushed upward.

The scarce resource is no longer typing. It is **judgment**:
- choosing an architecture that can survive contact with reality
- designing abstractions that remove complexity instead of hiding it
- deciding where to be strict, where to be flexible, and where to do nothing at all
